...
class EuApIEntity
  ...
  # @return [EuApI, Hash] the current EuApI data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of EuApI fields)
  def match_get
  ...
  # Load a single EuApI.
  #
  # @param reqmatch [EuApILoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.EuApI.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [EuApI, Hash] the loaded EuApI; raises DutchCustomerDataError on failure
  ...
  #
  # @param reqmatch [EuApIListMatch, Hash, nil] match filter (any subset of
  #   EuApI fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<EuApI>, Array] the matching EuApI items; raises DutchCustomerDataError on failure
