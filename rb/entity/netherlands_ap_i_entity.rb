...
class NetherlandsApIEntity
  ...
  def make
    opts = @_entopts.dup
    NetherlandsApIEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [NetherlandsApIListMatch, Hash, nil] match filter (any subset of
  #   NetherlandsApI fields); defaults to nil, treated as an empty match that lists all.
