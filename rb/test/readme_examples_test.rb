...
#      offline in seeded test mode (DutchCustomerDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DutchCustomerData_sdk.rb")
  SDK_CLASS = "DutchCustomerDataSDK"
  ...
  SDK_BASE = "DutchCustomerData_sdk"
