...
func registerSDKWords(r *eng.Registry, client *sdk.DutchCustomerDataSDK) {
...
func runOp(client *sdk.DutchCustomerDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
