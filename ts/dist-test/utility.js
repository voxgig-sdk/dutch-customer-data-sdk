...
function envOverride(m) {
    if ('TRUE' === process.env.DUTCH_CUSTOMER_DATA_TEST_LIVE ||
        'TRUE' === process.env.DUTCH_CUSTOMER_DATA_TEST_OVERRIDE) {
    ...
    m.DUTCH_CUSTOMER_DATA_TEST_EXPLAIN = process.env.DUTCH_CUSTOMER_DATA_TEST_EXPLAIN || m.DUTCH_CUSTOMER_DATA_TEST_EXPLAIN;
    return m;
}
