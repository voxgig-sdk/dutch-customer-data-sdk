...
(0, node_test_1.describe)('GlobalApIDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DutchCustomerDataSDK({
    ...
    (0, node_test_1.test)('direct-load-global_ap_i', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-global_ap_i', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-global_ap_i', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-global_ap_i', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.DUTCH_CUSTOMER_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DutchCustomerDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DUTCH_CUSTOMER_DATA_TEST_GLOBAL_AP_I_ENTID'];
    ...
    const client = new __1.DutchCustomerDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GlobalApIDirect.test.js.map