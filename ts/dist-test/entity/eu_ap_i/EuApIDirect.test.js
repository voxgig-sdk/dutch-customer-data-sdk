...
(0, node_test_1.describe)('EuApIDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-eu_ap_i', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-eu_ap_i', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-eu_ap_i', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-eu_ap_i', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DUTCH_CUSTOMER_DATA_TEST_EU_AP_I_ENTID'];
...
//# sourceMappingURL=EuApIDirect.test.js.map