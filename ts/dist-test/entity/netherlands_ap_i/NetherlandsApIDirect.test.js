...
(0, node_test_1.describe)('NetherlandsApIDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-netherlands_ap_i', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-netherlands_ap_i', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DUTCH_CUSTOMER_DATA_TEST_NETHERLANDS_AP_I_ENTID'];
...
//# sourceMappingURL=NetherlandsApIDirect.test.js.map