...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.DUTCHCUSTOMERDATA_TEST_LIVE ||
    'TRUE' === process.env.DUTCHCUSTOMERDATA_TEST_OVERRIDE
  ) {
  ...
  m.DUTCHCUSTOMERDATA_TEST_EXPLAIN = process.env.DUTCHCUSTOMERDATA_TEST_EXPLAIN || m.DUTCHCUSTOMERDATA_TEST_EXPLAIN
