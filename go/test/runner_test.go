...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("DUTCHCUSTOMERDATA_TEST_LIVE") == "TRUE" ||
		os.Getenv("DUTCHCUSTOMERDATA_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("DUTCHCUSTOMERDATA_TEST_EXPLAIN"); explain != "" {
