...
const testSeed = `map[string]any{"entity": map[string]any{"eu_ap_i": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "global_ap_i": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "netherlands_ap_i": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
