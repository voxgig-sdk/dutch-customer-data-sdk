...
// instead of `sdk.NewDutchCustomerDataSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DutchCustomerDataSDK  { return NewDutchCustomerDataSDK(nil) }
func Test() *DutchCustomerDataSDK { return TestSDK(nil, nil) }
