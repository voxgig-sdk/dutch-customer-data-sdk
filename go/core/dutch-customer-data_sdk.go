...
type DutchCustomerDataSDK struct {
	Mode     string
...
func (sdk *DutchCustomerDataSDK) OptionsMap() map[string]any {
...
func (sdk *DutchCustomerDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DutchCustomerDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DutchCustomerDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DutchCustomerDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DutchCustomerDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DutchCustomerDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DutchCustomerDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DutchCustomerDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DutchCustomerDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DutchCustomerDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DutchCustomerDataSDK {
	...
	sdk := NewDutchCustomerDataSDK(sdkopts)
	sdk.Mode = "test"
