...
## Install
```bash
go get github.com/voxgig-sdk/dutch-customer-data-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/dutch-customer-data-sdk=../path/to/github.com/voxgig-sdk/dutch-customer-data-sdk
```
...
```
github.com/voxgig-sdk/dutch-customer-data-sdk/
...
The root package (`github.com/voxgig-sdk/dutch-customer-data-sdk`) re-exports everything needed
