...
func NewGlobalApIEntity(client *core.DutchCustomerDataSDK, entopts map[string]any) *GlobalApIEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GlobalApIEntity) GetName() string { return e.name }
...
func (e *GlobalApIEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GlobalApIEntity) Deleted() bool {
	return e.deleted
}


func (e *GlobalApIEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGlobalApIEntity(e.client, opts)
}

func (e *GlobalApIEntity) Data(args ...any) any {
...
func (e *GlobalApIEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GlobalApI; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GlobalApIEntity) DataTyped(data ...GlobalApI) GlobalApI {
	if len(data) > 0 {
		return typedFrom[GlobalApI](e.Data(asMap(data[0])))
	}
	return typedFrom[GlobalApI](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GlobalApI (all fields
// optional at the wire level).
func (e *GlobalApIEntity) MatchTyped(match ...GlobalApI) GlobalApI {
	if len(match) > 0 {
		return typedFrom[GlobalApI](e.Match(asMap(match[0])))
	}
	return typedFrom[GlobalApI](e.Match())
}
...
func (e *GlobalApIEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GlobalApIEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GlobalApILoadMatch and returns an GlobalApI. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GlobalApIEntity) LoadTyped(reqmatch GlobalApILoadMatch, ctrl map[string]any) (GlobalApI, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GlobalApI{}, err
	}
	return typedFrom[GlobalApI](res), nil
}




func (e *GlobalApIEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GlobalApIListMatch and returns []GlobalApI. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GlobalApIEntity) ListTyped(reqmatch GlobalApIListMatch, ctrl map[string]any) ([]GlobalApI, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GlobalApI](res), nil
}




func (e *GlobalApIEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GlobalApICreateData and returns an GlobalApI. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GlobalApIEntity) CreateTyped(reqdata GlobalApICreateData, ctrl map[string]any) (GlobalApI, error) {
...
func (e *GlobalApIEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GlobalApIEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GlobalApIEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
