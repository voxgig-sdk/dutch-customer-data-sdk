...
func (e *NetherlandsApIEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NetherlandsApIEntity) Deleted() bool {
	return e.deleted
}
...
func (e *NetherlandsApIEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
