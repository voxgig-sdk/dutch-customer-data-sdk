...
func NewEuApIEntity(client *core.DutchCustomerDataSDK, entopts map[string]any) *EuApIEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EuApIEntity) GetName() string { return e.name }
...
func (e *EuApIEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EuApIEntity) Deleted() bool {
	return e.deleted
}


func (e *EuApIEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEuApIEntity(e.client, opts)
}

func (e *EuApIEntity) Data(args ...any) any {
...
func (e *EuApIEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EuApI; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EuApIEntity) DataTyped(data ...EuApI) EuApI {
	if len(data) > 0 {
		return typedFrom[EuApI](e.Data(asMap(data[0])))
	}
	return typedFrom[EuApI](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EuApI (all fields
// optional at the wire level).
func (e *EuApIEntity) MatchTyped(match ...EuApI) EuApI {
	if len(match) > 0 {
		return typedFrom[EuApI](e.Match(asMap(match[0])))
	}
	return typedFrom[EuApI](e.Match())
}
...
func (e *EuApIEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EuApIEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EuApILoadMatch and returns an EuApI. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EuApIEntity) LoadTyped(reqmatch EuApILoadMatch, ctrl map[string]any) (EuApI, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EuApI{}, err
	}
	return typedFrom[EuApI](res), nil
}




func (e *EuApIEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EuApIListMatch and returns []EuApI. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EuApIEntity) ListTyped(reqmatch EuApIListMatch, ctrl map[string]any) ([]EuApI, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EuApI](res), nil
}



func (e *EuApIEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EuApIEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EuApIEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EuApIEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
