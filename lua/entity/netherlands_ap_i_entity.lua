...
local NetherlandsApIEntity = {}
NetherlandsApIEntity.__index = NetherlandsApIEntity


function NetherlandsApIEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NetherlandsApIEntity)
  self._name = "netherlands_ap_i"
  self._client = client
...
function NetherlandsApIEntity:get_name()
  return self._name
end


function NetherlandsApIEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NetherlandsApIEntity.new(self._client, opts)
end
...
function NetherlandsApIEntity:mark_deleted()
  self._deleted = true
end


function NetherlandsApIEntity:deleted()
  return true == self._deleted
end


function NetherlandsApIEntity:data_set(args)
  if args ~= nil then
...
function NetherlandsApIEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NetherlandsApIEntity:match_set(args)
  if args ~= nil then
...
function NetherlandsApIEntity:match_get()
...
function NetherlandsApIEntity:stream(action, args, callopts)
...
function NetherlandsApIEntity:_run_op(ctx, post_done)
  local utility = self._utility
