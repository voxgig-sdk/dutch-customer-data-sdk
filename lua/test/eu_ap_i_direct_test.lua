...
describe("EuApIDirect", function()
  it("should direct-list-eu_ap_i", function()
    local setup = eu_ap_i_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-eu_ap_i", setup.live and "live" or "unit")
  ...
  it("should direct-load-eu_ap_i", function()
    local setup = eu_ap_i_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-eu_ap_i", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function eu_ap_i_direct_setup(mockres)
