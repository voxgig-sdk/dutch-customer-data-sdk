...
local SDK_MODULE = "dutch-customer-data_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["eu_ap_i"] = { ["test01"] = { id = "test01" } }, ["global_ap_i"] = { ["test01"] = { id = "test01" } }, ["netherlands_ap_i"] = { ["test01"] = { id = "test01" } } } }'
