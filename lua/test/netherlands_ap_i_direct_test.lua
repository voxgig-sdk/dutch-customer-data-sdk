...
describe("NetherlandsApIDirect", function()
  it("should direct-list-netherlands_ap_i", function()
    local setup = netherlands_ap_i_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-netherlands_ap_i", setup.live and "live" or "unit")
...
function netherlands_ap_i_direct_setup(mockres)
