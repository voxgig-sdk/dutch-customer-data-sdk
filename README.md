...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dutch-customer-data` | `npm install @voxgig-sdk/dutch-customer-data` |
| Python | `voxgig-sdk-dutch-customer-data` | `pip install voxgig-sdk-dutch-customer-data` |
| PHP | `voxgig-sdk/dutch-customer-data` | `composer require voxgig-sdk/dutch-customer-data` |
| Golang | `github.com/voxgig-sdk/dutch-customer-data-sdk/go` | `go get github.com/voxgig-sdk/dutch-customer-data-sdk/go` |
| Ruby | `voxgig-sdk-dutch-customer-data` | `gem install voxgig-sdk-dutch-customer-data` |
| Lua | `voxgig-sdk-dutch-customer-data` | `luarocks install voxgig-sdk-dutch-customer-data` |
