...
class NetherlandsApIEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DUTCHCUSTOMERDATA_TEST_NETHERLANDS_AP_I_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function netherlands_ap_i_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DUTCHCUSTOMERDATA_TEST_NETHERLANDS_AP_I_ENTID");
