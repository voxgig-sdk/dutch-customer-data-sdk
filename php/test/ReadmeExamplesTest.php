...
// DutchCustomerData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DutchCustomerDataSDK::test)
...
{
    private const SDK_CLASS = 'DutchCustomerDataSDK';
    ...
    private const SDK_BASE = 'dutchcustomerdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dutchcustomerdata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
