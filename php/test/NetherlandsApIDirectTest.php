...
class NetherlandsApIDirectTest extends TestCase
{
    public function test_direct_list_netherlands_ap_i(): void
    {
        $setup = netherlands_ap_i_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-netherlands_ap_i", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
