...
// DutchCustomerData SDK utility: graphql
//
...
class DutchCustomerDataGraphql
{
    ...
    // equivalent.
    public static function body(DutchCustomerDataContext $ctx): mixed
    {
    ...
    public static function errors(DutchCustomerDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
