...
// DutchCustomerData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DutchCustomerDataTransformResponse
{
    public static function call(DutchCustomerDataContext $ctx): mixed
    {
        ...
        $transform = DutchCustomerDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
