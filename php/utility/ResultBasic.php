...
// DutchCustomerData SDK utility: result_basic

class DutchCustomerDataResultBasic
{
    public static function call(DutchCustomerDataContext $ctx): ?DutchCustomerDataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof DutchCustomerDataError) ? $result->err->msg : (string)$result->err;
