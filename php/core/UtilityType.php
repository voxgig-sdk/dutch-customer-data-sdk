...
// DutchCustomerData SDK utility type

class DutchCustomerDataUtility
{
    ...
    public static function copy(DutchCustomerDataUtility $src): DutchCustomerDataUtility
    {
        $u = new DutchCustomerDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
