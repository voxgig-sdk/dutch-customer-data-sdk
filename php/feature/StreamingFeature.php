...
// DutchCustomerData SDK streaming feature
...
class DutchCustomerDataStreamingFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _iterate(DutchCustomerDataResult $result): \Generator
    {
    ...
    private function _streamable(DutchCustomerDataContext $ctx): bool
    {
