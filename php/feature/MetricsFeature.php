...
// DutchCustomerData SDK metrics feature
...
class DutchCustomerDataMetricsFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _record(DutchCustomerDataContext $ctx, bool $ok): void
    {
