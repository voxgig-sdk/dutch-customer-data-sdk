...
// DutchCustomerData SDK proxy feature
...
class DutchCustomerDataProxyFeature extends DutchCustomerDataBaseFeature
{
    ...
    public function init(DutchCustomerDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DutchCustomerDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
