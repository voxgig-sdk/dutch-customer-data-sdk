...
// DutchCustomerData SDK timeout feature
...
class DutchCustomerDataTimeoutFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _with_timeout(DutchCustomerDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DutchCustomerDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
