...
// DutchCustomerData SDK clienttrack feature
...
class DutchCustomerDataClienttrackFeature extends DutchCustomerDataBaseFeature
{
    ...
    public function PostConstruct(DutchCustomerDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DutchCustomerData-SDK';
