...
// DutchCustomerData SDK audit feature
...
class DutchCustomerDataAuditFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _emit(DutchCustomerDataContext $ctx, string $outcome): void
    {
