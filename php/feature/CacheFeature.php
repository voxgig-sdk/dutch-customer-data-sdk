...
// DutchCustomerData SDK cache feature
...
class DutchCustomerDataCacheFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _through(DutchCustomerDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
