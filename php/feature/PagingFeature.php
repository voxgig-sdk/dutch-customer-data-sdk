...
// DutchCustomerData SDK paging feature
...
class DutchCustomerDataPagingFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _is_list(DutchCustomerDataContext $ctx): bool
    {
