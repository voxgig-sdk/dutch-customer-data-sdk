...
// DutchCustomerData SDK debug feature
...
class DutchCustomerDataDebugFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _finish(DutchCustomerDataContext $ctx, bool $ok): void
    {
