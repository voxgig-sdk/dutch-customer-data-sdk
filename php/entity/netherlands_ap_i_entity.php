...
// DutchCustomerData SDK NetherlandsApI entity
...
class NetherlandsApIEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NetherlandsApIEntity($this->_client, $opts);
    }

    /**
     * @param NetherlandsApI|array $args NetherlandsApI data (assoc-array) to store.
     */
    ...
    /**
     * @return NetherlandsApI|array The current NetherlandsApI data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NetherlandsApI fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NetherlandsApI fields).
     */
     ...
     *
     * @param NetherlandsApIListMatch|array|null $reqmatch Match filter (any subset
     *   of NetherlandsApI fields) as an assoc-array; NetherlandsApIListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NetherlandsApI[]|array A list of NetherlandsApI items as assoc-arrays at
