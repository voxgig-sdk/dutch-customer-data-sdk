...
from dutchcustomerdata_sdk.utility import register

# Load features
from dutchcustomerdata_sdk.feature.base_feature import DutchCustomerDataBaseFeature
from dutchcustomerdata_sdk.features import _has_feature, _make_feature
...
class DutchCustomerDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DutchCustomerDataUtility()
    ...
    def get_utility(self):
        return DutchCustomerDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DutchCustomerDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def EuApI(self, data=None) -> "EuApIEntity":
        ...
        from dutchcustomerdata_sdk.entity.eu_ap_i_entity import EuApIEntity
    ...
    def GlobalApI(self, data=None) -> "GlobalApIEntity":
        ...
        from dutchcustomerdata_sdk.entity.global_ap_i_entity import GlobalApIEntity
    ...
    def NetherlandsApI(self, data=None) -> "NetherlandsApIEntity":
        ...
        from dutchcustomerdata_sdk.entity.netherlands_ap_i_entity import NetherlandsApIEntity
