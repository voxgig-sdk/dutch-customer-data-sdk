...
from dutchcustomerdata_sdk.dutchcustomerdata_types import (
    NetherlandsApI,
...
class NetherlandsApIEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NetherlandsApIEntity(self._client, opts)
    ...
    def data_get(self) -> NetherlandsApI:
    ...
    def match_get(self) -> NetherlandsApI:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[NetherlandsApI]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.NetherlandsApI().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
