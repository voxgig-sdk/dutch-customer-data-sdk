...
class GlobalApIEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GlobalApIEntity(self._client, opts)
    ...
    def create(self, reqdata: GlobalApICreateData, ctrl=None) -> GlobalApI:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
