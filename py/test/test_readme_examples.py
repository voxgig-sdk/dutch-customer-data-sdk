# DutchCustomerData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DutchCustomerDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DutchCustomerDataSDK(...) and DutchCustomerDataSDK.test(...) become
#      DutchCustomerDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dutchcustomerdata_sdk"
_SDK_CLASS = "DutchCustomerDataSDK"
...
_ENTITIES = {
    "EuApI": "eu_ap_i",
    "GlobalApI": "global_ap_i",
    "NetherlandsApI": "netherlands_ap_i",
}
