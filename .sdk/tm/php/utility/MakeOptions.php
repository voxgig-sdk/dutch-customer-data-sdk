...
// DutchCustomerData SDK utility: make_options

class DutchCustomerDataMakeOptions
{
    ...
    public static function call(DutchCustomerDataContext $ctx): array
    {
        ...
        //
        // `DutchCustomerDataSchema::optspec()` is built from the model:
        ...
        $optspec = DutchCustomerDataSchema::optspec();
