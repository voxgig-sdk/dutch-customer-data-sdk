...
// DutchCustomerData SDK utility: fetcher

class DutchCustomerDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DutchCustomerDataSDK/1.0)';
    ...
    public static function call(DutchCustomerDataContext $ctx, string $fullurl, array $fetchdef): array
    {
