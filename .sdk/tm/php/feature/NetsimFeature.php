...
// DutchCustomerData SDK netsim feature
...
class DutchCustomerDataNetsimFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _simulate(DutchCustomerDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DutchCustomerDataContext $ctx, array $applied): void
    {
        $client = $this->client;
