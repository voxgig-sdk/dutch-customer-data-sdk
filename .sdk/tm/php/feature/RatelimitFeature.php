...
// DutchCustomerData SDK ratelimit feature
...
class DutchCustomerDataRatelimitFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _acquire(DutchCustomerDataContext $ctx): void
    {
    ...
    private function _track(DutchCustomerDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
