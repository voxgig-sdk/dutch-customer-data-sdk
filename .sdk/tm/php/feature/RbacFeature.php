...
// DutchCustomerData SDK rbac feature
...
class DutchCustomerDataRbacFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _required(DutchCustomerDataContext $ctx): ?string
    {
    ...
    private function _reject(DutchCustomerDataContext $ctx, string $required): void
    {
    ...
    private function _track(DutchCustomerDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
