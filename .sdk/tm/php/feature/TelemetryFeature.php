...
// DutchCustomerData SDK telemetry feature
...
class DutchCustomerDataTelemetryFeature extends DutchCustomerDataBaseFeature
{
    ...
    private function _close(DutchCustomerDataContext $ctx, bool $ok): void
    {
