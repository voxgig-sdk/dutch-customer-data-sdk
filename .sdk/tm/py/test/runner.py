...
class DutchCustomerDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DutchCustomerDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DutchCustomerDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DutchCustomerDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
