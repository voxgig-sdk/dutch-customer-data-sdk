...
|---|---|---|
| `ts/` | @voxgig-sdk/dutch-customer-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dutch-customer-data-sdk \
      --repository voxgig-sdk/dutch-customer-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dutch-customer-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dutch-customer-data-sdk --id=<id>` removes it.
