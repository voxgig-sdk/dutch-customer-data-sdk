...
type Args struct {
	Entity string         `json:"entity" jsonschema:"eu_ap_i | global_ap_i | netherlands_ap_i"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DutchCustomerDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dutch-customer-data_list",
		Description: "List records from DutchCustomerData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dutch-customer-data_load",
		Description: "Load a single record from DutchCustomerData. " +
...
func runOp(client *sdk.DutchCustomerDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DutchCustomerDataSDK, name string) (sdk.DutchCustomerDataEntity, error) {
	switch strings.ToLower(name) {
	case "eu_ap_i":
		return client.EuApI(nil), nil
	case "global_ap_i":
		return client.GlobalApI(nil), nil
	case "netherlands_ap_i":
		return client.NetherlandsApI(nil), nil
