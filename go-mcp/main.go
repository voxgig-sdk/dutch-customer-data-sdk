// Command DutchCustomerData-mcp is an MCP server exposing the DutchCustomerData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DutchCustomerData_list  — list records of an entity
//	DutchCustomerData_load  — load a single record of an entity
//
